...
public class LuosimaoDuanxinUtil {
    ...
    //短信平台的APIkey
    //短信
    private static final String DUANXIN_API_KEY = "key-82aca3b098dc827f6cca2ee868086c08";//需要使用自己的APIkey
    //语音
    private static final String SPEAK_API_KEY = "key-47d30eacf9f6f755fe43af53dfa13010";//需要使用自己的APIkey
